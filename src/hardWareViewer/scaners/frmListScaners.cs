...
{
    public partial class frmListScaners : Form
    {

        public frmListScaners()
        {
            InitializeComponent();
        ...
        {
            dtJournalScaner = readSQL.getListScanersJournal();
            setFilter();
        ...
        private void btExcel_Click(object sender, EventArgs e)
        {
            ...
            Logging.Comment("Произведена выгрузка в Excel отчета «Список сканеров»");
            ...
            report.AddSingleValue("Список сканеров", indexRow, 1);
