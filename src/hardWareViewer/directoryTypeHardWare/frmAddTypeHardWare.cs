...
{
    public partial class frmAddTypeHardWare : Form
    {
        private int id = -1;
        ...
        private void btSave_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtResult = readSQL.setTypeHardWare(id, tbName.Text.Trim(), 1, true,chbIsActive.Checked,tbInvCode.Text.Trim());
        ...
        private void frmAddTypeHardWare_FormClosing(object sender, FormClosingEventArgs e)
        {
